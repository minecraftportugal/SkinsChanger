...
public class JSONParser
{
    ...
    private int peekStatus(final LinkedList<Integer> statusStack) {
    ...
    public Object parse(final Reader in, final ContainerFactory containerFactory) throws IOException, ParseException {
        this.reset(in);
        final LinkedList<Integer> statusStack = new LinkedList<Integer>();
                    ...
                    switch (this.status) {
                        ...
                        case 4: {
                            switch (this.token.type) {
                                ...
                                case 0: {
                                    ...
                                    final Map<String, Object> parent = valueStack.getFirst();
                        ...
                        case 3: {
                            switch (this.token.type) {
                                ...
                                case 0: {
                                    final List<Object> val = valueStack.getFirst();
    ...
    public void parse(final Reader in, final ContentHandler contentHandler, boolean isResume) throws IOException, ParseException {
        if (!isResume) {
            this.reset(in);
            this.handlerStatusStack = new LinkedList<Integer>();
        }
        ...
        final LinkedList<Integer> statusStack = this.handlerStatusStack;
        try {
            do {
                Label_0911: {
                    switch (this.status) {
