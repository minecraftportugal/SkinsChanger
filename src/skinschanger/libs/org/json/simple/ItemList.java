...
public class ItemList
{
    ...
    public ItemList(final String s, final String sp, final boolean isMultiToken) {
        this.sp = ",";
        this.split(s, sp, this.items = new ArrayList<String>(), isMultiToken);
    }
    ...
    public void split(final String s, final String sp, final List<String> append, final boolean isMultiToken) {
        if (s == null || sp == null) {
            return;
        }
        if (isMultiToken) {
    ...
    public void split(final String s, final String sp, final List<String> append) {
        if (s == null || sp == null) {
            return;
        }
        int pos = 0;
